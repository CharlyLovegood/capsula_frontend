                    ...
                    <Box margin={{vertical: "30px"}}>
                        ...
                        <Box direction="row" gap="10px">
                            <a title="telegram" href="https://t.me/booookovsky">
                                <img alt="telegram" className={styles.icon} src="https://image.flaticon.com/icons/svg/906/906377.svg" />
                            </a>
                            <a title="vk" href="https://vk.com/public189055518">
                                <img alt="vk" className={styles.icon} src="https://image.flaticon.com/icons/svg/145/145813.svg" />
                            </a>
                        </Box>
